import { TokenLocation, TokenPoint } from '@myrmidon/cadmus-core';
...
export class TiledTextLayerView {
   ...
   */
  public getTileAt(y: number, x: number): TextTileLayerView {
   ...
   */
  public setAllTilesViewState(state: {
    checked?: boolean;
    frIndex?: number;
  }): void {
   ...
   */
  public setFragmentLocations(locations: TokenLocation[]): void {
   ...
   */
  public toggleLinearTileCheck(y: number, x: number, checked: boolean): void {
